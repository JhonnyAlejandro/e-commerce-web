<div class="max-w-7xl mx-auto py-12 px-6 xl:px-8">
    <nav class="space-x-12 columns-2 -mb-6 md:flex md:justify-center">
        <div class="pb-6">
            <a href="" class="text-lg leading-7 text-gray-600 hover:text-gray-900">Términos y condiciones</a>
        </div>
        <div class="pb-6">
    ...
    <div class="flex justify-center space-x-10 mt-10">
        <a href="https://www.facebook.com/estacionarcoiriskids?mibextid=ZbWKwL" target="_blank" class="text-gray-400 hover:text-gray-500">
            <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="w-9 h-9">
                <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
            </svg>
        </a>
        <a href="https://www.instagram.com/estacionarcoiriskids/?igshid=MmU2YjMzNjRlOQ%3D%3D" target="_blank" class="text-gray-400 hover:text-gray-500">
            <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="w-9 h-9">
