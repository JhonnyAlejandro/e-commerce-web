        ...
        <form action="{{ route('products.destroy', $product->id) }}" method="POST">
            ...
            <div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <p class="mt-4 text-lg text-gray-500">¿Está seguro de que desea eliminar producto? Todos los datos serán eliminados permanentemente de la base de datos. Esta acción no se puede deshacer.</p>
                </div>
            </div>
            <div class="mt-5 md:grid md:grid-cols-2 md:grid-flow-row-dense md:gap-3 md:mt-6">
                <x-button type="submit" class="inline-flex justify-center w-full bg-red-600 hover:bg-red-500 md:col-start-2">
