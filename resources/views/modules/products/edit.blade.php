                ...
                <div class="md:col-span-full">
                    ...
                    <div class="flex justify-center mt-2 py-10 px-6 rounded-lg border-gray-900/[0.25] border-4 border-dashed">
                        <div class="text-center">
                            <img id="image{{ $product->id }}" class="mb-3 rounded-lg" style="display: none;">
                            <svg id="icon{{ $product->id }}" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="w-16 h-16 mb-3 mx-auto text-gray-300">
                            ...
                            <x-label for="edit-image{{ $product->id }}" class="text-indigo-600 cursor-pointer hover:text-indigo-500">
                                <span>Cargar un archivo</span>
                                <x-input id="edit-image{{ $product->id }}" class="sr-only" type="file" name="image" accept="image/*" />
                            </x-label>
