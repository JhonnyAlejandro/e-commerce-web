<x-modal>
    <div class="relative flex flex-col w-full pt-6 pb-8 md:pb-6 xl:py-8">
                        ...
                        <div>
                            <div class="flex justify-between text-xl font-semibold text-gray-900">
                                ...
                                <div class="block ml-4 md:flex md:items-center">
                                    <p class="font-medium text-gray-500 line-through">$570.000</p>
                                    <p class="md:ml-2">$490.200</p>
                                </div>
                            </div>
                            <p class="mt-1 text-lg text-gray-500">Alquiler - Inflables</p>
                        </div>
                        <div class="flex flex-1 justify-between items-end text-lg">
                            <p class="text-gray-500">Tiempo: 4 Hora</p>
                            <div class="flex">
                    ...
                    <div class="flex flex-1 flex-col ml-4 md:ml-6">
                        <div>
                            <div class="flex justify-between text-xl font-semibold text-gray-900">
                                <h3>Lego</h3>
                                <div class="block ml-4 md:flex md:items-center">
                                    <p class="font-medium text-gray-500 line-through">$360.000</p>
                                    <p class="md:ml-2">$320.400</p>
                                </div>
                            </div>
                            <p class="mt-1 text-lg text-gray-500">Venta - Inflables</p>
                        </div>
                        <div class="flex flex-1 justify-between items-end text-lg">
                ...
                <div class="flow-root">
                    <dl class="-my-4 text-lg divide-gray-200 divide-y-2">
                        <div class="flex justify-between items-center py-4">
                            ...
                            <dd class="text-gray-600">$930.000</dd>
                        </div>
                        <div class="flex justify-between items-center py-4">
                            <dt class="text-gray-600">Descuento</dt>
                            <dd class="text-gray-600">-$119.400</dd>
                        </div>
                        <div class="flex justify-between items-center py-4">
                            <dt class="text-xl font-semibold text-gray-900">Precio total</dt>
                            <dd class="text-xl font-semibold text-gray-900">$810.600</dd>
                        </div>
                    </dl>
                </div>
            </div>
        ...
        <div class="flex justify-end mt-8 px-4">
            <a href="{{ route('checkout') }}" class="inline-flex justify-center w-full py-3 px-8 text-lg font-semibold text-white bg-indigo-600 rounded-md hover:bg-indigo-500 md:w-auto">
