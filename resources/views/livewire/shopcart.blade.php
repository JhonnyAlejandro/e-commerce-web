    ...
    <div x-data="{ isOpen: false }">
        ...
        <button type="button" @click="isOpen = true" class="group flex items-center -m-2 p-2">
            ...
            <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                aria-hidden="true" class="shrink-0 w-7 h-7 text-gray-400 group-hover:text-gray-500">
                        ...
                        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                            <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                                <div class="flex items-start justify-between">
                                    <h2 class="text-lg font-medium text-gray-900" id="slide-over-title">Carrito de compra
                                    </h2>
                            ...
                            <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                                <div class="flex justify-between text-sm font-medium text-gray-900">
                                    <p>Subtotal</p>
                                    <p class="price text-gray-500 sm:text-base md:text-lg">
